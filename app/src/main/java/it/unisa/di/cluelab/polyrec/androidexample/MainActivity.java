    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gestureView.addOnGestureListener(new GestureOverlayView.OnGestureListener() {
            ...
            public void onGestureEnded(GestureOverlayView gestureOverlayView, MotionEvent motionEvent) {
                ...
                for (GesturePoint p : gestureOverlayView.getCurrentStroke())
                    g.addPoint(new TPoint(p.x, p.y, p.timestamp));
                Result r = recognizer.recognize(g);
                message.setText(Html.fromHtml("Result: <b>" + r.getName() + "</b> (" + r.getScore() + ")"));
            }
